 ...
 * @throws DIEngineError Если декоратор применён не к getter или Container/Module.
 */
  ...
  return function provideGetter<Host extends Container | Module>(
    ...
    context.addInitializer(function () {
      if (this instanceof Container) {
        ...
        throw new DIEngineError(`@provide можно применять только к Container или Module`);
      }
    });
